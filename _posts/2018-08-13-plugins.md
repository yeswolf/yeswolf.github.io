...
If you are a reviewer from Google or a addon user with _some special unique mind_ and you nothing about Disqus comments, please first understand the following: 
1. The link "Disqus' Privacy Policy" is not the privacy policy for this addon. One more time: it's not the Privacy Policy for any of the applications I wrote including "Export to HTML". And one more time: <span style="color:red; font-size: 250%">IT IS **NOT** THE PRIVACY POLICY FOR THE "EXPORT TO HTML" ADDON</span>
2. If you still think that it's the privacy policy for this addon, please note that whatever you think <span style="color:red; font-size: 250%"><a href="https://yeswolf.github.io/plugins/2020/04/03/privacy.html">**THIS IS**</a> THE PRIVACY POLICY FOR "EXPORT TO HTML" ADDON</span>
